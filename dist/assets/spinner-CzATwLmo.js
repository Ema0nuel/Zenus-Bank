import{L as s}from"./logo-yCyWWFG1.js";function n(){if(document.getElementById("logo-spinner-preloader"))return;const e=document.createElement("div");e.id="logo-spinner-preloader",e.className=`
    ...
    `;const o=document.getElementById("app");o&&o.classList.add("opacity-0","transition-opacity","duration-300"),document.body.append(e)}function a(e=500){const o=document.getElementById("logo-spinner-preloader"),t=document.getElementById("app");o&&(o.style.transition="opacity 0.5s",o.style.opacity="0",setTimeout(()=>{o.remove(),t&&(t.classList.remove("opacity-0"),t.classList.add("opacity-100"))},e))}export{a as e,n as s};
