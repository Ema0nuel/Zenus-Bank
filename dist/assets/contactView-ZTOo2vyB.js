import{n as o}from"./navbar-CNAggbqQ.js";import{f as m}from"./footer-DOGfXAWF.js";import{s as t}from"./toast-DRvdR0y9.js";import{r as c}from"./reset-CYKpHJhn.js";import"./logo-nobg-BVMQOOtC.js";import"./logo-yCyWWFG1.js";const r="zenusbanking@gmail.com",l="+447529555635",h=()=>{c("Contact Us");function i(){o().pageEvents?.();const e=document.getElementById("contactForm");e&&e.addEventListener("submit",async n=>{n.preventDefault();const s=Object.fromEntries(new FormData(e));if(!s.name||!s.email||!s.message){t("Please fill in all required fields.","error");return}try{e.querySelector('button[type="submit"]').disabled=!0,await new Promise(d=>setTimeout(d,1200)),t("Your message has been sent!","success"),e.reset()}catch{t("Failed to send message. Please try again.","error")}finally{e.querySelector('button[type="submit"]').disabled=!1}});const a=document.getElementById("prevContactForm");a&&a.addEventListener("submit",n=>{n.preventDefault(),t("Form submitted (demo only)","info"),a.reset()})}return{html:`
      ${o().html}
