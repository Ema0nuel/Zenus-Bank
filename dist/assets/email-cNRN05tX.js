import{s as i}from"./sendEmail-89Z52C2k.js";async function l({name:e,email:t,accountNumber:o,ip:n,geo:s}){const a=`
      ...
      <div style="max-width: 600px; margin: auto; background: white; border-radius: 12px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); overflow: hidden;">
        ...
        <div style="padding: 24px;">
          ...
          <ul style="list-style: none; padding: 0;">
            <li><strong>Account Number:</strong> ${o}</li>
            <li><strong>Registered IP:</strong> ${n}</li>
            <li><strong>Region:</strong> ${s.city}, ${s.region}, ${s.country}</li>
  ...
  `;await i({to:t,subject:"Welcome to Zenus Bank",html:a})}async function c({to:e,name:t,otp:o}){const n=`
  ...
  `;await i({to:e,subject:"Your One-Time Password (OTP) for Login",html:n})}export{c as a,l as s};
