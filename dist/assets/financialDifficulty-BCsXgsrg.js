import{n as i}from"./navbar-CNAggbqQ.js";import{f as t}from"./footer-DuuTHOh-.js";import{r as s}from"./reset-CYKpHJhn.js";import"./logo-nobg-BVMQOOtC.js";import"./logo-yCyWWFG1.js";const d=()=>{const e=i();s("Financial Difficulty Assistance");function a(){e.pageEvents()}return{html:`
      ${e.html}
        ...
        <section class="py-4 border-t border-brand-grape/20" id="Apply">
          <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="md:col-span-2">
              ...
              <p class="mb-4"><strong>Mortgage Help Centre<br></strong>Email: <a href="mailto: zenusbanking@gmail.com" class="text-brand-sun underline"> zenusbanking@gmail.com</a></p>
            </div>
          </div>
        </section>
