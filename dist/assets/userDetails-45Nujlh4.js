import{s as e}from"./supabaseClient-CvVHAHOf.js";import{A as m}from"./AdminNavbar-DXVtneOk.js";import{r as u}from"./adminAuth-Dn35BI8v.js";import{s as b}from"./toast-DRvdR0y9.js";import"./logo-nobg-BVMQOOtC.js";import"./logo-yCyWWFG1.js";const y=async t=>{if(!await u())return;const{data:i}=await e.from("profiles").select("*").eq("id",t).single(),{data:d}=await e.from("accounts").select("*").eq("user_id",t).single(),{data:o}=await e.from("kyc_requests").select("*").eq("user_id",t).order("created_at",{ascending:!1}).limit(1).single(),{data:l}=await e.from("transactions").select("*").eq("user_id",t).order("created_at",{ascending:!1}).limit(10);return{html:`
      ${m("users")}
