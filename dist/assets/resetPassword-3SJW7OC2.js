import{n as p}from"./navbar-CNAggbqQ.js";import{r as g}from"./reset-CYKpHJhn.js";import{s as i}from"./toast-DRvdR0y9.js";import{a as w,e as c}from"./spinner-KTJn75tI.js";import{s as u}from"./supabaseClient-CL6H8VOx.js";import{N as v}from"./logo-nobg-BVMQOOtC.js";import{L as x}from"./logo-yCyWWFG1.js";const I=async()=>{g("Reset Password");const b=p();if(!(await u.auth.getSession()).data.session){window.location.href="/login";return}function m(){b.pageEvents?.();const n=document.getElementById("reset-form"),o=document.getElementById("password"),a=document.getElementById("confirmPassword"),s=n?.querySelector('button[type="submit"]');document.querySelectorAll(".showHidePwd").forEach(e=>{e.addEventListener("click",function(){const t=document.getElementById(this.dataset.target);t.type==="password"?(t.type="text",e.textContent="HIDE"):(t.type="password",e.textContent="SHOW")})});function l(){const e=o.value,t=a.value,d=e.length>=8&&e===t;a.style.borderColor=t&&e!==t?"rgb(239, 68, 68)":"",s.disabled=!d}o.addEventListener("input",l),a.addEventListener("input",l),n&&n.addEventListener("submit",async e=>{e.preventDefault();const t=o.value,d=a.value;if(t!==d){i("Passwords do not match","error");return}s.disabled=!0,s.innerHTML='<i class="fas fa-spinner fa-spin"></i> Resetting...',w();try{const{error:r}=await u.auth.updateUser({password:t});if(c(),r)throw r}catch(r){c();const f=r?.message||"Failed to reset password";i(f,"error"),s.disabled=!1,s.innerHTML='Reset Password <i class="fas fa-key text-sm"></i>';return}i("Password reset successful!","success"),setTimeout(()=>window.location.href="/login",2e3)})}return{html:`
          ...
          <div class="w-full max-w-md space-y-8">
            <div class="flex flex-col items-center mb-6">
              <a href="/" data-nav class="flex items-center justify-center mb-4">
                ...
                <img src="${x}" alt="Zenus Bank logo" class="h-16 w-auto hidden dark:block" />
              </a>
    ...
    `,pageEvents:m}};export{I as default};
