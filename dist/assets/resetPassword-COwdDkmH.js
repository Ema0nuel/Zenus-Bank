import{n as b}from"./navbar-CNAggbqQ.js";import{r as m}from"./reset-CYKpHJhn.js";import{s as d}from"./toast-DRvdR0y9.js";import{a as f,e as p}from"./spinner-KTJn75tI.js";import{s as g}from"./supabaseClient-B1HaFb4P.js";import{N as v}from"./logo-nobg-BVMQOOtC.js";import{L as w}from"./logo-yCyWWFG1.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js/+esm";const I=()=>{m("Reset Password");const c=b();function u(){c.pageEvents?.();const r=document.getElementById("reset-form"),n=document.getElementById("password"),a=document.getElementById("confirmPassword"),s=r?.querySelector('button[type="submit"]');document.querySelectorAll(".showHidePwd").forEach(e=>{e.addEventListener("click",function(){const t=document.getElementById(this.dataset.target);t.type==="password"?(t.type="text",e.textContent="HIDE"):(t.type="password",e.textContent="SHOW")})});function i(){const e=n.value,t=a.value,o=e.length>=8&&e===t;a.style.borderColor=t&&e!==t?"rgb(239, 68, 68)":"",s.disabled=!o}n.addEventListener("input",i),a.addEventListener("input",i),r&&r.addEventListener("submit",async e=>{e.preventDefault();const t=n.value,o=a.value;if(t!==o){d("Passwords do not match","error");return}s.disabled=!0,s.innerHTML='<i class="fas fa-spinner fa-spin"></i> Resetting...',f();const{error:l}=await g.auth.updateUser({password:t});p(),l?(d(l.message||"Failed to reset password","error"),s.disabled=!1,s.innerHTML='Reset Password <i class="fas fa-key text-sm"></i>'):(d("Password reset successful!","success"),setTimeout(()=>window.location.href="/login",2e3))})}return{html:`
