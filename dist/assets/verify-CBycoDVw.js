const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/loginHandler-gRi8nDpu.js","assets/supabaseClient-CL6H8VOx.js","assets/email-cNRN05tX.js","assets/sendEmail-89Z52C2k.js"])))=>i.map(i=>d[i]);
import{_ as l}from"./index-ClfUhsy0.js";import{n as c}from"./navbar-CNAggbqQ.js";import{r as m}from"./reset-CYKpHJhn.js";import{s as e}from"./toast-DRvdR0y9.js";import{verifyOtp as g}from"./otp-D7TvNSYN.js";import"./logo-nobg-BVMQOOtC.js";import"./logo-yCyWWFG1.js";import"./supabaseClient-CL6H8VOx.js";const w=async()=>{m("Verify Login");const o=c();async function i(){o.pageEvents?.();const r=document.getElementById("verifyotp");r&&r.addEventListener("submit",async s=>{s.preventDefault();const t=r.otp.value.trim(),a=sessionStorage.getItem("lastAccessID")||"";if(t.length!==6){e("OTP must be 6 digits.","error");return}try{await g(a,t),e("Login successful!","success"),window.location.href="/dashboard"}catch(d){e(d.message||"Invalid or expired OTP.","error")}r.reset()});const n=document.getElementById("resendBtn");n&&n.addEventListener("click",async()=>{const s=sessionStorage.getItem("lastAccessID")||"";if(!s){e("Please login again to resend OTP.","error");return}try{const{loginAndSendOtp:t}=await l(async()=>{const{loginAndSendOtp:a}=await import("./loginHandler-gRi8nDpu.js");return{loginAndSendOtp:a}},__vite__mapDeps([0,1,2,3]));await t(s,""),e("OTP resent to your email.","info")}catch{e("Could not resend OTP. Please try again.","error")}})}return{html:`
    ...
    `,pageEvents:i}};export{w as default};
