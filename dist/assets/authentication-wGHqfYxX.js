import{n}from"./navbar-CNAggbqQ.js";import{r}from"./reset-CYKpHJhn.js";import{s as i}from"./toast-Dx2DSKhR.js";import{N as o}from"./logo-nobg-BVMQOOtC.js";import{L as d}from"./logo-yCyWWFG1.js";const v=async()=>{r("Email Verification Required");const a=n();async function t(){a.pageEvents?.();const e=document.getElementById("resendemail");e&&e.addEventListener("submit",async s=>{s.preventDefault(),i("Verification email resent! (Implement backend logic)","info")})}return{html:`
