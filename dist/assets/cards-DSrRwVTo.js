import{s as c}from"./supabaseClient-CL6H8VOx.js";import{n as _}from"./Navbar-DMGlxEFS.js";import{s as g}from"./toast-DRvdR0y9.js";import{r as $}from"./reset-CYKpHJhn.js";import"./logo-yCyWWFG1.js";function E(){let t="";for(let a=0;a<16;a++)t+=Math.floor(Math.random()*10);return t.replace(/(.{4})/g,"$1 ").trim()}function S(){return""+Math.floor(100+Math.random()*900)}function L(){const t=new Date,a=t.getFullYear()+4;return`${(t.getMonth()+1).toString().padStart(2,"0")}/${a.toString().slice(-2)}`}function w({card_number:t,card_type:a,card_holder:i,expiry:n,cvv:v}){const o=a==="visa"?'<span class="font-bold italic tracking-tighter text-white text-2xl">VISA</span>':`<div class="flex items-center space-x-1">
