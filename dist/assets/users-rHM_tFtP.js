import{s as n}from"./supabaseClient-CL6H8VOx.js";import{A as w}from"./AdminNavbar-ObVEf85P.js";import{r as E}from"./adminAuth-Dn35BI8v.js";import{s as u}from"./toast-DRvdR0y9.js";import{s as v}from"./sendEmail-89Z52C2k.js";import{s as $}from"./signupHandler-qh0bhfUc.js";import"./logo-nobg-BVMQOOtC.js";import"./logo-yCyWWFG1.js";import"./email-cNRN05tX.js";const f="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imlmb2RicXlnc2Nkc3h4bHhmanh3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1ODQ3MzEyOCwiZXhwIjoyMDc0MDQ5MTI4fQ.hgTFx1O5bbgwJvTJlY4xXG3DS7eh1m1QRReLoefSD0E",I="https://biyuydrbirwsbtnymakk.supabase.co";async function S(l){return(await fetch(`${I}/auth/v1/admin/users/${l}`,{method:"DELETE",headers:{apikey:f,Authorization:`Bearer ${f}`,"Content-Type":"application/json"}})).ok}function x(){return`<div class="flex justify-center items-center py-16">
