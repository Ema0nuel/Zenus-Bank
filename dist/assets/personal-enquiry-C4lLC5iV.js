import{n}from"./navbar-CNAggbqQ.js";import{f as s}from"./footer-DuuTHOh-.js";import{s as o}from"./toast-DRvdR0y9.js";import{r as i}from"./reset-CYKpHJhn.js";import"./logo-nobg-BVMQOOtC.js";import"./logo-yCyWWFG1.js";const f=()=>{i("Personal Enquiry");function t(){n().pageEvents?.();const e=document.getElementById("personalEnquiryForm");e&&e.addEventListener("submit",async r=>{r.preventDefault();const a=Object.fromEntries(new FormData(e));if(!a.firstName||!a.lastName||!a.phone||!a.email||!a.postcode){o("Please fill in all required fields.","error");return}try{e.querySelector('button[type="submit"]').disabled=!0,await new Promise(l=>setTimeout(l,1200)),o("Your enquiry has been submitted!","success"),e.reset()}catch{o("Failed to submit. Please try again.","error")}finally{e.querySelector('button[type="submit"]').disabled=!1}})}return{html:`
      ${n().html}
