import{n as l}from"./navbar-CNAggbqQ.js";import{r as m}from"./reset-CYKpHJhn.js";import{s as o}from"./toast-Dx2DSKhR.js";import{s as c,e as u}from"./spinner-CzATwLmo.js";import{s as f}from"./supabaseClient-B1HaFb4P.js";import{N as b}from"./logo-nobg-BVMQOOtC.js";import{L as p}from"./logo-yCyWWFG1.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js/+esm";const E=()=>{m("Forgot Password");const i=l();function d(){i.pageEvents?.();const s=document.getElementById("forgot-form"),a=document.getElementById("email"),e=s?.querySelector('button[type="submit"]');a&&a.addEventListener("input",r=>{const t=/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(r.target.value);a.style.borderColor=t?"":"rgb(239, 68, 68)",e&&(e.disabled=!t)}),s&&s.addEventListener("submit",async r=>{r.preventDefault();const t=a.value.trim();if(!t||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t))return;e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin"></i> Sending...',c();const{error:n}=await f.auth.resetPasswordForEmail(t,{redirectTo:"https://zenusbanking.com/reset-password"});u(),n?(o(n.message||"Failed to send reset instructions","error"),e.disabled=!1,e.innerHTML='Send Instructions <i class="fas fa-paper-plane text-sm"></i>'):(o("Password reset instructions sent to your email","success"),setTimeout(()=>window.location.href="/login",2e3))})}return{html:`
